    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (tokenParts.length !== 2 || tokenParts[0] !== "Bearer") {
                return next((0, http_errors_1.default)(400, "Invalid authorization format."));
            }
            const parsedToken = token.split(" ")[1];
            try {
                const decoded = jsonwebtoken_1.default.verify(parsedToken, config_1.default.jwtSecretKey);
